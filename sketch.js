 ...
 background(0);
  ...
  if (World.frameCount % 100 == 0) {
   switch(select_balloon ){
    ...
    select_balloon.addImage(red_balloonImage);
    break;
    case 2: // chamar o balão azul
    select_balloon.addImage(blue_balloonImage);
    break;
    case 3: // chamar o balão verde
    select_balloon.addImage(green_balloonImage);
    break;
    case 4: // chamar o balão rosa
    select_balloon.addImage(pink_balloonImage);
    break;
    default:break;
  }}
